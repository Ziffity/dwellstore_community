 ...
 */
class Ziffity_Adminhtml_Block_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('disclaimer', 'textarea', array(
            'name' => 'disclaimer',
            'label' => Mage::helper('salesrule')->__('Disclaimer Message'),
            'title' => Mage::helper('salesrule')->__('Disclaimer Message'),
            'style' => 'height: 100px;',
        ));
