...
class Mage_Page_Block_Html_Topmenu extends Mage_Core_Block_Template
{
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
			...
			{		
            	$html .= '<div>';
				if($this->escapeHtml($child->getName()) == 'SALE'){
				$html .= '<div style="width:100%;"><a href="' . $child->getUrl() . '" ' . $outermostClassCode . '><div style="float: left;"><span style="color:#ed3e3a;">' . $this->escapeHtml($child->getName()). '</span></div></a></div><div class="droparrow"></div>';
				} else {
				$html .= '<div style="width:100%;"><a href="' . $child->getUrl() . '" ' . $outermostClassCode . '><div style="float: left;"><span>' . $this->escapeHtml($child->getName()). '</span></div></a></div><div class="droparrow"></div>';
				}
				$html .= '</div>';
			}
			else
            ...
            if ($child->hasChildren()) {
				...
				/* KD Custom Code */
                $html .= '<ul class="level' . $childLevel .' show-ul "';
