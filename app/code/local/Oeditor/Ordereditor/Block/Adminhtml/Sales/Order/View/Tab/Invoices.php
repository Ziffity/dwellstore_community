 ...
 */
class Oeditor_Ordereditor_Block_Adminhtml_Sales_Order_View_Tab_Invoices
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    public function __construct()
    {
		...
		$this->setTemplate('ordereditor/grid.phtml');
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('state', array(
			...
			'renderer'	=> new Oeditor_Ordereditor_Block_Adminhtml_Ordermanager_Grid_Renderer_Invoicestatus()
        ));
