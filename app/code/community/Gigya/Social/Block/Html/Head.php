 ...
 *
 */
class Gigya_Social_Block_Html_Head extends Fooman_Speedster_Block_Page_Html_Head {
  ...
  public function getCssJsHtml() {
    ...
    // Need to clear out subsequent calls to builder for SASS integration
    if (isset($this->_data['items']['skin_css/sass/stylesheets/screen.css'])) {
      foreach ($this->_data['items'] as $path => $value) {
        if ($path != 'skin_css/sass/stylesheets/screen.css') {
          unset($this->_data['items'][$path]);
        }
      }
    }
