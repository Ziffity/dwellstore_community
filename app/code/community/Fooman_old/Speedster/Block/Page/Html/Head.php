...
class Fooman_Speedster_Block_Page_Html_Head extends Mage_Page_Block_Html_Head
{
    ...
    public function getCssJsHtml()
    {
        ...
        foreach ($this->_data['items'] as $item) {
            ...
            switch ($item['type']) {
                case 'js':
					if($item['params'] == 'minify="exclude"') {
                        $lines[$if]['other'][] = sprintf($script, $baseJs.$item['name'], '');
                    }
                    elseif (strpos($item['name'], 'packaging.js') !== false) {
                ...
                case 'skin_js':
					if ($item['params'] == 'minify="exclude"') {
                        $lines[$if]['other'][] = sprintf($script, $this->getSkinUrl($item['name']), '');
                    }
					else {
                ...
                case 'inline_js':
                    $lines[$if]['other'][] = sprintf('<script type="text/javascript">%s</script>', $item['params']);
                    break;
