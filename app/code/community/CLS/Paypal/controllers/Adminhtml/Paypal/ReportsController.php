 ...
 */ 
require_once Mage::getModuleDir('controllers', 'Mage_Paypal').DS.'Adminhtml'.DS.'Paypal'.DS.'ReportsController.php';
class CLS_Paypal_Adminhtml_Paypal_ReportsController extends Mage_Adminhtml_Controller_Action
{
	...
	{
    	$fileName   = 'Paypal_Settlement.csv';
    	$content    = $this->getLayout()->createBlock('paypal/adminhtml_settlement_report_grid')->getCsvFile();
