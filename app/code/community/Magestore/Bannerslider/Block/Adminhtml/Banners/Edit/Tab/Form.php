...
class Magestore_Bannerslider_Block_Adminhtml_Banners_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        if (Mage::getSingleton('adminhtml/session')->getBannersData()) {
            $data = Mage::getSingleton('adminhtml/session')->getBannersData();
        ...
        $fieldset = $form->addFieldset('banners_form', array('legend' => Mage::helper('bannerslider')->__('Banner information')));
