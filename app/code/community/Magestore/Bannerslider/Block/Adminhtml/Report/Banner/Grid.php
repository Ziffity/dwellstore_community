...
class Magestore_Bannerslider_Block_Adminhtml_Report_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('table_banner' => $collection->getTable('bannerslider/banners')), 'main_table.banner_id = table_banner.banner_id', array('banner_name' => 'table_banner.name', 'banner_url' => 'table_banner.click_url'));
