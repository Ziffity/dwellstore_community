 ...
 */
class Magestore_Bannerslider_Model_Banners extends Mage_Core_Model_Abstract {
    ...
    public function _construct() {
        ...
        $this->_init('bannerslider/banners');
    }

    protected function _beforeSave() {
        if ($storeId = $this->getStoreId()) {
            $defaultStore = Mage::getModel('bannerslider/banners')->load($this->getId());
