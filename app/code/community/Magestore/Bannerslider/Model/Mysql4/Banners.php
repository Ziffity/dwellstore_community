 ...
 */
class Magestore_Bannerslider_Model_Mysql4_Banners extends Mage_Core_Model_Mysql4_Abstract {

    public function _construct() {
        $this->_init('bannerslider/banners', 'banner_id');
    }
    ...
    public function getListBannerOfBlock($block) {
        try {
            ...
            $select = $this->_getReadAdapter()->select()
                    ->from($this->getTable('banners'), array('*', $randomise ? 'Rand() as order' : ''))
